...
public class Encode {
     ...
     * {@link Encode#encode(Serializable)}ed bytes of the parametric type
     * <code>T</code>.
     * <p>
    ...
    public static final <T extends Serializable> byte[] encode(T obj) {
        ...
        // catch (Exception e) {
        // e.printStackTrace();
        // SystemEnum.err.format("error in verifying the decoding of the encoded object %s",
